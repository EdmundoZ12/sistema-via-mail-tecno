package com.tecnoweb.grupo7sa.communication;

import com.tecnoweb.grupo7sa.interfaces.IEmailEventListener;
import com.tecnoweb.grupo7sa.utils.Command;
import com.tecnoweb.grupo7sa.utils.Email;
import com.tecnoweb.grupo7sa.utils.Extractor;
...
public class MailVerificationThread implements Runnable {
    ...
    private final static String USER = "grupo07sa";
